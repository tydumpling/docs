...
function reName(name: string) {
  return name === 'Yuan Tang' ? 'tydumpling' : name
}
    ...
    <section class="flex flex-col gap-y-[8px] overflow-hidden">
      ...
      <div>
        ...
        <span>
          ...
          >CC BY-NC-SA 4.0</a>
          许可协议。转载请注明来自
          <a href="https://tydumpling.github.io/blog/" rel="noreferrer" target="_blank">tydumpling</a></span>！
      </div>
    </section>
  </div>
</template>
